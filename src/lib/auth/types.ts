...
export type DemoUser = {id:string;name:string;email:string;role:Role;verified:boolean;profileComplete:boolean;orcid?:string;institution?:string;applicationStatus?:ApplicationStatus};
